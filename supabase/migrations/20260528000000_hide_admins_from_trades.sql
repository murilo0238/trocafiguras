...
-- Add flag to hide admin accounts from the trading panel
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS show_in_trades boolean NOT NULL DEFAULT true;

-- Hide existing admin/super_admin users from trades
...
-- Trigger: whenever someone is granted an admin role, hide them from trades
